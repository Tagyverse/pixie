        ...
        >
          <div className="flex items-center justify-center gap-5">
            {socialLinks.map((social, idx) => {
              ...
              const stringHeight = isLong ? 'h-7' : 'h-4';
              return (
                <div
                  key={social.id}
                ...
                >
                  ...
                  <a
                    ...
                    className="w-10 h-10 rounded-full border-2 flex items-center justify-center transition-all hover:scale-110 hover:shadow-md"
                    style={{
                      borderColor: '#C4B590',
